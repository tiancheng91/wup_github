	...
	public void doExecute() {
		try {
			...
			try {
				...
				if(RunEnv.isProxyEnable()){
				    HttpResponseWrap httpResponseWrap =new HttpClientProxy().execute((BasicHttpParams)httpParams,new HttpPostWrap(mHttpPost));
				    httpResponse = httpResponseWrap.getResponse();
				} else {
				    httpResponse = client.execute(mHttpPost);
				}
